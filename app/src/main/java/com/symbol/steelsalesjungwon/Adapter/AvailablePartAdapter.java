...
public class AvailablePartAdapter extends ArrayAdapter<Stock> implements BaseActivityInterface, Filterable {
   ...
   /* String lastPart;//마지막에 추가된 품목,규격
    ...
    public AvailablePartAdapter(Context context, int layoutResourceID, ArrayList data, TextView txtBadge) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (item != null) {
            ...
            String stockQty = myFormatter.format(Double.parseDouble(item.Qty));

            txtQty.setText(stockQty);
    ...
    public void addItem(String Qty, String PartCode, String PartName, String PartSpec, String PartSpecName, boolean checked, String MarketPrice) {
        ...
        item.PartSpec=PartSpec;
        item.PartSpecName=PartSpecName;
